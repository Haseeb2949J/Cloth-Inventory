...
export function AuthForm({ mode }: AuthFormProps) {
    ...
    try {
      if (mode === "login") {
        ...
        if (data.user && !data.user.email_confirmed_at) {
          ...
          // User is auto-confirmed (email confirmations are disabled)
  ...
  const getDescription = () => {
    switch (mode) {
      ...
      case "signup":
        return "Create a new account to start managing your clothes"
      case "forgot-password":
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-2 space-y-2">
                    ...
                    <div className="text-xs text-muted-foreground">
                      ...
                      <p>You can disable email confirmations in your Supabase dashboard:</p>
                      <p>Authentication → Settings → "Enable email confirmations" (turn OFF)</p>
                      <Button
                        variant="link"
                        size="sm"
