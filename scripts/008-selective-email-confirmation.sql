-- Enable selective email confirmation for signup and password changes only
-- Regular login remains simple, but signup and password changes require email verification
...
-- Note: Configure these in your Supabase Dashboard:
